...
from egreedyagent import EpsilonGreedyAgent
...
def compete_q_vs_e_greedy(num_games=100):
    p1 = Player("Q-Learning",exp_rate=0)
    p2 = EpsilonGreedyAgent("Epsilon-Greedy",exp_rate=0)
    p1.loadPolicy("policy_p1")
    st = State(p1, p2)
    st.compete(num_games)

def compete_e_greedy_vs_rand(num_games=100):
    p1 = EpsilonGreedyAgent("Epsilon-Greedy",exp_rate=0)
    p2 = RandomAgent("Random agent")
    st = State(p1, p2)
    st.compete(num_games)
...
# compete_q_v_q(num_games=10000)
# compete_q_vs_rand(num_games=10000)
play()
# compete_e_greedy_vs_rand(num_games=10000)
# compete_q_vs_e_greedy(num_games=10000)
# play_against_e_greedy()